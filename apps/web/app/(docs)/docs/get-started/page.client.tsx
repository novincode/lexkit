    ...
    <div className="space-y-12">
      ...
      <div className="text-center space-y-6 py-8">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          ...
          editors with LexKit. We'll cover installation, basic setup, theming,
          and extensions.
        </p>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center space-y-4 mb-8">
          ...
          <p className="text-lg text-muted-foreground">
            Experience the power of LexKit with this interactive editor. Use the
      ...
      <Card className="border-0 shadow-sm bg-gradient-to-br from-primary/5 to-primary/10">
        <CardHeader>
          ...
          <CardDescription>Install LexKit and its dependencies</CardDescription>
        </CardHeader>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-800 dark:text-green-200">
                  That's it! LexKit is now installed and ready to use. Let's
          ...
          <div className="flex flex-col md:grid md:grid-cols-2 gap-4 md:gap-6">
            <div className="bg-background/80 rounded-lg p-4 border">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Use RichText as a LexKit extension with createEditorSystem for
            ...
            <div className="bg-background/80 rounded-lg p-4 border">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                ...
                directly, but LexKit's RichTextExtension is built on top of it
      ...
      <Card className="border-0 shadow-sm bg-gradient-to-br from-blue-50/50 to-indigo-50/50 dark:from-blue-950/20 dark:to-indigo-950/20">
        ...
        <CardContent className="space-y-6">
          <div className="prose prose-sm max-w-none">
            <p>
              LexKit is built around three core concepts that work together to
      ...
      <Card className="border-0 shadow-sm bg-gradient-to-br from-purple-50/50 to-pink-50/50 dark:from-purple-950/20 dark:to-pink-950/20">
        ...
        <CardContent className="space-y-6">
          <div className="bg-background/80 rounded-lg p-4 border">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Use LexKit's theme system to apply classnames to different editor
      ...
      <Card className="border-0 shadow-sm bg-gradient-to-br from-green-50/50 to-emerald-50/50 dark:from-green-950/20 dark:to-emerald-950/20">
        ...
        <CardContent className="space-y-6">
          <div className="bg-background/80 rounded-lg p-4 border">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              LexKit comes with 25+ extensions for common features. Here's how
              to use them:
            </p>
            <SimpleCodeBlock
