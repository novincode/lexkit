    ...
    <div className="max-w-4xl mx-auto space-y-12">
      ...
      <div className="text-center space-y-6 py-8">
        <div className="text-center">
          ...
          <p className="text-xl text-muted-foreground mt-2">Powerful hyperlink functionality for your editor</p>
        </div>
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          Add automatic URL detection, manual link creation, and intelligent paste behavior to your LexKit editor.
          Handle links with ease and provide a seamless editing experience.
        </p>
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:grid md:grid-cols-3 gap-4 md:gap-6">
          <Card className="border-primary/20">
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                Automatically detects and converts URLs to clickable links as you type,
                with customizable validation rules.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-primary/20">
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                Smart paste behavior that handles URLs differently based on context -
                cursor paste vs. selected text replacement.
              </p>
            </CardContent>
          </Card>
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-4 md:gap-6">
          <Card className="border-green-200 dark:border-green-800">
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                Paste a URL when no text is selected. Controlled by <code className="bg-muted px-1 rounded text-xs">autoLinkUrls</code> setting.
              </p>
              <div className="mt-3 space-y-2">
                <div className="text-sm">
                  <Badge variant="outline" className="mr-2">autoLinkUrls: true</Badge>
                  <span className="text-muted-foreground">Creates clickable link</span>
                </div>
                <div className="text-sm">
                  <Badge variant="outline" className="mr-2">autoLinkUrls: false</Badge>
                  <span className="text-muted-foreground">Inserts as plain text</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-blue-200 dark:border-blue-800">
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                Paste a URL over selected text. Controlled by <code className="bg-muted px-1 rounded text-xs">linkSelectedTextOnPaste</code> setting.
              </p>
              <div className="mt-3 space-y-2">
                <div className="text-sm">
                  <Badge variant="outline" className="mr-2">linkSelectedTextOnPaste: true</Badge>
                  <span className="text-muted-foreground">Links selected text with URL</span>
                </div>
                <div className="text-sm">
                  <Badge variant="outline" className="mr-2">linkSelectedTextOnPaste: false</Badge>
                  <span className="text-muted-foreground">Replaces text with linked URL</span>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Card>
          <CardContent className="p-0">
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell className="font-mono text-sm">autoLinkText</TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        <strong>Note:</strong> Only affects URLs typed directly in the editor, not pasted content.
                      </p>
                    </div>
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-mono text-sm">autoLinkUrls</TableCell>
                  <TableCell>
                    <Badge variant="secondary">boolean</Badge>
                  </TableCell>
                  <TableCell>
                    Control whether URLs are automatically linked when pasted. When false, pasted URLs remain as plain text.
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-mono text-sm">linkSelectedTextOnPaste</TableCell>
                  <TableCell>
                    <Badge variant="secondary">boolean</Badge>
                  </TableCell>
                  <TableCell>
                    When pasting URLs over selected text, control whether to link the selected text or replace it with the URL.
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-mono text-sm">validateUrl</TableCell>
                  <TableCell>
                    <Badge variant="secondary">(url: string) ⇒ boolean</Badge>
                  </TableCell>
                  <TableCell>
                    Custom validation function for URLs. Return true to accept, false to reject.
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
  ...
  linkExtension.configure({
    linkSelectedTextOnPaste: false  // Replace selected text with URL instead of linking it
              ...
              <SimpleCodeBlock
                ...
                html={getHighlightedCode('link-extension-custom-validation') || ''}
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-4 md:gap-6">
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                <div>
                  <code className="bg-muted px-2 py-1 rounded text-sm">insertLink(url?, text?)</code>
                  <p className="text-sm text-muted-foreground mt-1">
                    Insert or apply link to selection. Prompts for URL if not provided.
                  </p>
                </div>
                <div>
                  <code className="bg-muted px-2 py-1 rounded text-sm">removeLink()</code>
                  <p className="text-sm text-muted-foreground mt-1">
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                <div>
                  <code className="bg-muted px-2 py-1 rounded text-sm">isLink()</code>
                  <p className="text-sm text-muted-foreground mt-1">
