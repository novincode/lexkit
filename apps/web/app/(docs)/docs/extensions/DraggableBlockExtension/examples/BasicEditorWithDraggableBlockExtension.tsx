...
import { createEditorSystem, draggableBlockExtension, historyExtension, RichText } from "@lexkit/editor"
...
const { Provider, useEditor } = createEditorSystem<typeof extensionsWithDraggableBlocks>()
