    ...
    <div className="max-w-4xl mx-auto space-y-12">
      ...
      <div className="text-center space-y-6 py-8">
        <div className="text-center">
          ...
          <p className="text-xl text-muted-foreground mt-2">Complete control over your editor's appearance</p>
        </div>
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          Customize every aspect of your LexKit editor with powerful theming capabilities.
          From CSS classes to Tailwind utilities, make your editor match your design system perfectly.
        </p>
      ...
      <div className="space-y-6">
        <h2 className="text-3xl font-bold text-center">Theme System Overview</h2>
          ...
          <Card>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell className="font-medium">Text Formatting</TableCell>
                    <TableCell><code>text.bold</code></TableCell>
                    <TableCell>Bold text styling</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Text Formatting</TableCell>
                    <TableCell><code>text.italic</code></TableCell>
                    <TableCell>Italic text styling</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Text Formatting</TableCell>
                    <TableCell><code>text.underline</code></TableCell>
                    <TableCell>Underline text styling</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Text Formatting</TableCell>
                    <TableCell><code>text.strikethrough</code></TableCell>
                    <TableCell>Strikethrough styling</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Text Formatting</TableCell>
                    <TableCell><code>text.code</code></TableCell>
                    <TableCell>Inline code styling</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Content Elements</TableCell>
                    <TableCell><code>paragraph</code></TableCell>
                    <TableCell>Paragraph styling</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Content Elements</TableCell>
                    <TableCell><code>heading.h1-h6</code></TableCell>
                    <TableCell>Heading levels (h1 through h6)</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Content Elements</TableCell>
                    <TableCell><code>quote</code></TableCell>
              ...
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell><code>toolbar.button</code></TableCell>
                    <TableCell>Base button styling</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Toolbar</TableCell>
                    <TableCell><code>toolbar.buttonActive</code></TableCell>
                    <TableCell>Active button styling</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Toolbar</TableCell>
                    <TableCell><code>toolbar.buttonDisabled</code></TableCell>
                    <TableCell>Disabled button styling</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Toolbar</TableCell>
                    <TableCell><code>toolbar.group</code></TableCell>
                  ...
                  <TableRow>
                    <TableCell className="font-medium">Containers</TableCell>
                    <TableCell><code>wrapper</code></TableCell>
                    <TableCell>Editor wrapper element</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Containers</TableCell>
                    <TableCell><code>richText.contentEditable</code></TableCell>
                    <TableCell>Content editable area</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Containers</TableCell>
                    <TableCell><code>richText.placeholder</code></TableCell>
          ...
          <Card>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell className="font-medium">Draggable Blocks</TableCell>
                    <TableCell><code>draggable.handle</code></TableCell>
                    <TableCell>Drag handle styling</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Draggable Blocks</TableCell>
                    <TableCell><code>draggable.handleHover</code></TableCell>
                    <TableCell>Hover state for drag handle</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Draggable Blocks</TableCell>
                    <TableCell><code>draggable.blockDragging</code></TableCell>
                    <TableCell>Block being dragged styling</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Draggable Blocks</TableCell>
                    <TableCell><code>draggable.dropIndicator</code></TableCell>
                    <TableCell>Drop zone indicator styling</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Floating Toolbar</TableCell>
                    <TableCell><code>floatingToolbar.container</code></TableCell>
                    <TableCell>Toolbar container styling</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Floating Toolbar</TableCell>
                    <TableCell><code>floatingToolbar.button</code></TableCell>
                    <TableCell>Toolbar buttons styling</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Floating Toolbar</TableCell>
                    <TableCell><code>floatingToolbar.buttonActive</code></TableCell>
      ...
      <div className="space-y-6">
        <h2 className="text-3xl font-bold text-center">Extension-Specific Theming</h2>
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-center leading-relaxed">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <SimpleCodeBlock
                ...
                html={getHighlightedCode('theming-dynamic-theme-switching') || ''}
