...
import { createEditorSystem, boldExtension, italicExtension, underlineExtension, RichText } from "@lexkit/editor"
...
const lightTheme: LexKitTheme = {
  ...
  toolbar: {
    button: 'px-3 py-2 text-sm font-medium rounded-md border border-gray-300   text-gray-700 transition-colors',
...
const darkTheme: LexKitTheme = {
  ...
  toolbar: {
    button: 'px-3 py-2 text-sm font-medium rounded-md border border-gray-600 bg-gray-800  text-gray-200 transition-colors',
    buttonActive: 'bg-purple-500 text-white border-purple-500 hover:bg-purple-600',
    group: 'flex gap-1'
  },
...
const extensions = [boldExtension, italicExtension, underlineExtension] as const
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold">Theme: {isDark ? 'Dark' : 'Light'}</h3>
